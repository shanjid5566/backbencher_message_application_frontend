...
//   onBack: () => void;
//   socket: any;
//   onStartVideoCall?: () => void;  // 👈 New prop
//   onStartAudioCall?: () => void;  // 👈 New prop
// }
...
//         {partner ? (
//           <>
//             <Avatar user={{ id: partner.id, name: partner.name, avatarUrl: partner.image || "https://avatar.iran.liara.run/public", isOnline: partner.isOnline, lastSeen: partner.lastSeen } as any} size="md" showStatus />
...
//           {/* 👇 Live Buttons with onClick */}
//           <button onClick={onStartAudioCall} className="w-8 h-8 rounded-full hover:bg-surface-700 flex items-center justify-center transition-colors text-surface-400 hover:text-surface-200" title="Voice call">
//             <Phone size={17} />
//           </button>
//           <button onClick={onStartVideoCall} className="w-8 h-8 rounded-full hover:bg-surface-700 flex items-center justify-center transition-colors text-surface-400 hover:text-surface-200" title="Video call">
//             <Video size={17} />
//           </button>
