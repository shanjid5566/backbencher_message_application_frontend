...
// import api from '@/lib/axios'; // 👈 API import
...
//   // 🔴 🆕 Fetching data when modal opens
//   useEffect(() => {
//     if (isOpen) {
//       setIsLoading(true);
//       api.get('/calls/history') // 👈 আপনার ব্যাকএন্ডের সঠিক রাউটে হিট
...
//                   <img 
//                     src={partner?.image || `https://ui-avatars.com/api/?name=${partner?.name || "User"}&background=random`} 
//                     alt={partner?.name} 
